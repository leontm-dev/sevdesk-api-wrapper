...
var Report = /** @class */ (function () {
    ...
    Report.prototype.exportInvoiceList = function (download, view, sevQuery) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_1.API(this.apiKey).request("/Report/invoiceList", {
    ...
    Report.prototype.exportOrderList = function (download, view, sevQuery) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_1.API(this.apiKey).request("/Report/orderList", {
                        download: String(download),
                        view: view,
                        sevQuery: JSON.stringify(sevQuery),
                    }, { method: "GET" })];
    ...
    Report.prototype.exportContactList = function (download, sevQuery) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_1.API(this.apiKey).request("/Report/contactList", {
                        download: String(download),
                        sevQuery: JSON.stringify(sevQuery),
                    }, { method: "GET" })];
            });
    ...
    Report.prototype.exportVoucherList = function (download, sevQuery) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_1.API(this.apiKey).request("/Report/voucherList", {
                        download: String(download),
                        sevQuery: JSON.stringify(sevQuery),
                    }, { method: "GET" })];
            });
