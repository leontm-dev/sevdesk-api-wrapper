...
export class CheckAccount {
    ...
    async createANewFileImportAccount(body) {
        const response = await fetch(`${apiUrl}/CheckAccount/Factory/fileImportAccount`, {
            method: "POST",
            headers: {
                Authorization: this.apiKey,
    ...
    async createANewClearingAccount(body) {
        const response = await fetch(`${apiUrl}/CheckAccount/Factory/clearingAccount`, {
            method: "POST",
            headers: {
                Authorization: this.apiKey,
                "Content-Type": "application/json",
    ...
    async getTheBalanceAtAGivenDate(checkAccountId, date) {
        const response = await fetch(`${apiUrl}/CheckAccount/${checkAccountId}/getBalanceAtDate?=date=${date}`, { method: "GET", headers: { Authorization: this.apiKey } });
        const data = await response.json();
        return {
            status: response.status,
            response: {
