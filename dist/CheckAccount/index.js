...
var CheckAccount = /** @class */ (function () {
     ...
     */
    CheckAccount.prototype.getMany = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CheckAccount", undefined, { method: "GET" })];
     ...
     */
    CheckAccount.prototype.createFileImportAccount = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CheckAccount/Factory/fileImportAccount", undefined, {
                            method: "POST",
     ...
     */
    CheckAccount.prototype.createNewClearingAccount = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CheckAccount/Factory/clearingAccount", undefined, {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify(body),
                        })];
     ...
     * @returns Array of objects (CheckAccount model)
     */
    CheckAccount.prototype.getOne = function (checkAccountId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CheckAccount/".concat(checkAccountId), undefined, { method: "GET" })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    CheckAccount.prototype.updateOne = function (checkAccountId, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CheckAccount/".concat(checkAccountId), undefined, {
                            method: "PUT",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify(body),
                        })];
     ...
     */
    CheckAccount.prototype.deleteOne = function (checkAccountId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CheckAccount/".concat(checkAccountId), undefined, { method: "DELETE" })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    CheckAccount.prototype.getOnesBalanceAtDate = function (checkAccountId, date) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CheckAccount/".concat(checkAccountId, "/getBalanceAtDate"), { date: date.toISOString() }, { method: "GET" })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
