...
export class CommunicationWay {
     ...
     */
    async retrieveCommunicationWays(contactId, type, main) {
        const query = [];
        if (contactId) {
        ...
        const response = await fetch(`${apiUrl}/CommunicationWay?{${query.join("&")}}`, {
            method: "GET",
            headers: {
     ...
     */
    async createANewContactCommunicationWay(body) {
     ...
     * @returns Array of objects (CommunicationWay model)
     */
    async findCommunicationWayByID(communicationWayId) {
        const response = await fetch(`${apiUrl}/CommunicationWay/${communicationWayId}`, {
            method: "GET",
            headers: {
                Authorization: this.apiKey,
            },
     ...
     */
    async deletesACommunicationWay(communicationWayId) {
        const response = await fetch(`${apiUrl}/CommunicationWay/${communicationWayId}`, {
            method: "DELETE",
            headers: {
                Authorization: this.apiKey,
     ...
     */
    async updateAExistingCommunicationWay(communicationWayId, body) {
        const response = await fetch(`${apiUrl}/CommunicationWay/${communicationWayId}`, {
            method: "PUT",
            headers: {
                Authorization: this.apiKey,
     ...
     */
    async retrieveCommunicationWayKeys() {
