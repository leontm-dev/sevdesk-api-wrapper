...
var CommunicationWay = /** @class */ (function () {
     ...
     */
    CommunicationWay.prototype.getMany = function (contactId, type, main) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (main)
                            queryObj["main"] = main;
                        return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CommunicationWay", queryObj, { method: "GET" })];
     ...
     */
    CommunicationWay.prototype.createOne = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CommunicationWay", undefined, {
                            method: "POST",
     ...
     * @returns Array of objects (CommunicationWay model)
     */
    CommunicationWay.prototype.getOne = function (communicationWayId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CommunicationWay/".concat(communicationWayId), undefined, { method: "GET" })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    CommunicationWay.prototype.deleteOne = function (communicationWayId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CommunicationWay/".concat(communicationWayId), undefined, { method: "DELETE" })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    CommunicationWay.prototype.updateOne = function (communicationWayId, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CommunicationWay/".concat(communicationWayId), undefined, {
                            method: "PUT",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify(body),
                        })];
     ...
     */
    CommunicationWay.prototype.getManyKeys = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/CommunicationWayKey", undefined, { method: "GET" })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
