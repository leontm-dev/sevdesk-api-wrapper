...
var ContactAddress = /** @class */ (function () {
    function ContactAddress(apiKey) {
        this.apiKey = apiKey;
    }
    /**
     ...
     */
    ContactAddress.prototype.createOne = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/ContactAddress", undefined, {
                            method: "POST",
                            headers: {
     ...
     */
    ContactAddress.prototype.getMany = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/ContactAddress", undefined, { method: "GET" })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     * @returns
     */
    ContactAddress.prototype.getOne = function (contactAddressId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/ContactAddress/".concat(contactAddressId), undefined, { method: "GET" })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     * @returns Returns created contact address
     */
    ContactAddress.prototype.updateOne = function (contactAddressId, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/ContactAddress/".concat(contactAddressId), undefined, {
                            method: "PUT",
     ...
     */
    ContactAddress.prototype.deleteOne = function (contactAddressId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/ContactAddress/".concat(contactAddressId), undefined, { method: "DELETE" })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
