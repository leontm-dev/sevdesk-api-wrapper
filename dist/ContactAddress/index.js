...
var ContactAddress = /** @class */ (function () {
     ...
     */
    ContactAddress.prototype.createANewContactAddress = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, node_fetch_1.default)("".concat(index_js_1.apiUrl, "/ContactAddress"), {
                            method: "POST",
                            headers: {
     ...
     */
    ContactAddress.prototype.retrieveContactAddresses = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @returns
     */
    ContactAddress.prototype.findContactAddressByID = function (contactAddressId) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, node_fetch_1.default)("".concat(index_js_1.apiUrl, "/ContactAddress/").concat(contactAddressId), {
                            headers: {
                                Authorization: this.apiKey,
                            },
                            method: "GET",
     ...
     * @returns Returns created contact address
     */
    ContactAddress.prototype.updateAExistingContactAddress = function (contactAddressId, body) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    ContactAddress.prototype.deletesAContactAddress = function (contactAddressId) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
