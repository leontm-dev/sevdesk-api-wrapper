import { InvoiceModule_Body_BookOne, InvoiceModule_Body_CreateOne, InvoiceModule_Body_CreateOneFromOrder, InvoiceModule_Body_CreateReminderForOne, InvoiceModule_Body_MarkOneAsSent, InvoiceModule_Body_RenderOne, InvoiceModule_Body_SendOneViaEmail } from "./types/body.types";
import { InvoiceModule_Response_BookOne, InvoiceModule_Response_CheckifOneIsPartiallyPaid, InvoiceModule_Response_CreateOne, InvoiceModule_Response_EnshrineOne, InvoiceModule_Response_GetMany, InvoiceModule_Response_GetOne, InvoiceModule_Response_GetOnesPdf, InvoiceModule_Response_GetOnesPositions, InvoiceModule_Response_GetOnesXML, InvoiceModule_Response_RenderOne, InvoiceModule_Response_ResetOnesStatusToDraft } from "./types/response.types";
export declare class Invoice {
     ...
     * @returns
     */
    getMany(status?: 100 | 200 | 1000, invoiceNumber?: string, startDate?: Date, endDate?: Date, contactId?: number): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_GetMany>>;
    /**
  ...
  To do that you will need to create a so called Abschlagsrechnung by setting the invoiceType parameter to AR.
     ...
     */
    createOne(body: InvoiceModule_Body_CreateOne): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_CreateOne>>;
    /**
     ...
     * @returns
     */
    getOne(invoiceId: number): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_GetOne>>;
    /**
     ...
     * @returns
     */
    getOnesPositions(invoiceId: number, limit?: number, offset?: number, embed?: string[]): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_GetOnesPositions>>;
    /**
     ...
     * @returns
     */
    createOneFromOrder(body: InvoiceModule_Body_CreateOneFromOrder): Promise<import("../types/Response").IApiResponse<import("./types/base.types").Invoice>>;
    /**
     ...
     * @returns
     */
    createReminderForOne(invoiceId: number, body: InvoiceModule_Body_CreateReminderForOne): Promise<import("../types/Response").IApiResponse<import("./types/base.types").Invoice>>;
    /**
     ...
     * @returns
     */
    checkIfOneIsPartiallyPaid(invoiceId: number): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_CheckifOneIsPartiallyPaid>>;
    /**
  ...
  The cancellation invoice will be automatically paid and the source invoices status will change to 'cancelled'.
     ...
     */
    cancelOne(invoiceId: number): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_CheckifOneIsPartiallyPaid>>;
    /**
  ...
  Please be aware that changing an invoice after it has been sent to a customer is not an allowed bookkeeping process.
     ...
     */
    renderOne(invoiceId: number, body: InvoiceModule_Body_RenderOne): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_RenderOne>>;
    /**
  ...
  Please note, that in production an invoice is not allowed to be changed after this happened!
     ...
     */
    sendOneViaEmail(invoiceId: number, body: InvoiceModule_Body_SendOneViaEmail): Promise<import("../types/Response").IApiResponse<import("../types/models.types").Email>>;
    /**
     ...
     * @returns
     */
    getOnesPdf(invoiceId: number, download: boolean, preventSendBy: boolean): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_GetOnesPdf>>;
    /**
     ...
     * @returns A xml file
     */
    getOnesXML(invoiceId: number): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_GetOnesXML>>;
    /**
     ...
     * @returns
     */
    markOneAsSent(invoiceId: number, body: InvoiceModule_Body_MarkOneAsSent): Promise<import("../types/Response").IApiResponse<import("./types/base.types").Invoice>>;
    /**
  ...
  Enshrined invoices cannot be changed. This operation cannot be undone.
     ...
     * @returns
     */
    enshrineOne(invoiceId: number): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_EnshrineOne>>;
    /**
  ...
  for more information look here.
     ...
     */
    bookOne(invoiceId: number, body: InvoiceModule_Body_BookOne): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_BookOne>>;
    /**
  ...
  This endpoint cannot be used for recurring invoices ("invoiceType": "WKR"). Use Invoice/Factory/saveInvoice instead.
     ...
     */
    resetOnesStatusToOpen(invoiceId: number): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_ResetOnesStatusToDraft>>;
    /**
  ...
  Use Invoice/Factory/saveInvoice instead.
     ...
     * @returns changed invoice
     */
    resetOnesStatusToDraft(invoiceId: number): Promise<import("../types/Response").IApiResponse<InvoiceModule_Response_ResetOnesStatusToDraft>>;
}
