...
var Contact = /** @class */ (function () {
     ...
     */
    Contact.prototype.getNextCustomerNumber = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/Contact/Factory/getNextCustomerNumber", {}, { method: "GET" })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new common_classes_js_1.API(this.apiKey).request("/Contact/Factory/findContactsByCustomFieldValue", queryObj, {
                                method: "GET",
                            })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
     ...
     */
    Contact.prototype.checkCustomerNumberAvailability = function (customerNumber) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_js_1.API(this.apiKey).request("/Contact/Mapper/checkCustomerNumberAvailability", { customerNumber: customerNumber }, { method: "GET" })];
            });
        });
    };
    /**
     ...
     * @returns Array of objects (Contact model)
     */
    Contact.prototype.getMany = function (depth, customerNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var queryObj;
            return __generator(this, function (_a) {
                queryObj = {};
                if (depth)
                    queryObj["depth"] = depth;
                if (customerNumber)
                    queryObj["customerNumber"] = customerNumber;
                return [2 /*return*/, new common_classes_js_1.API(this.apiKey).request("/Contact", queryObj, { method: "GET" })];
            });
        });
    };
    /**
     ...
     */
    Contact.prototype.createOne = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_js_1.API(this.apiKey).request("/Contact", undefined, {
                        method: "POST",
     ...
     */
    Contact.prototype.getOne = function (contactId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_js_1.API(this.apiKey).request("/Contact/".concat(contactId), undefined, { method: "GET" })];
            });
        });
    };
    /**
     ...
     */
    Contact.prototype.updateOne = function (contactId, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_js_1.API(this.apiKey).request("/Contact/".concat(contactId), undefined, {
                        method: "PUT",
                        headers: { "Content-Type": "application/json" },
                        body: JSON.stringify(body),
                    })];
     ...
     */
    Contact.prototype.deleteOne = function (contactId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_js_1.API(this.apiKey).request("/Contact/".concat(contactId), undefined, { method: "DELETE" })];
            });
        });
    };
    /**
     ...
     * @returns
     */
    Contact.prototype.getOnesTabsItemCount = function (contactId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new common_classes_js_1.API(this.apiKey).request("/Contact/".concat(contactId, "/getTabsItemCount"), undefined, { method: "GET" })];
            });
        });
    };
    return Contact;
