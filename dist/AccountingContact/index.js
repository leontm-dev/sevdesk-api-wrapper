...
var AccountingContact = /** @class */ (function () {
     ...
     * @returns
     */
    AccountingContact.prototype.retrieveAccountingContact = function (contactId) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, (0, node_fetch_1.default)("".concat(index_js_1.apiUrl, "/AccountingContact?contact[id]=").concat(contactId, "&contact[objectName]=Contact"), {
                            method: "GET",
                            headers: {
     ...
     */
    AccountingContact.prototype.createANewAccountingContact = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, (0, node_fetch_1.default)("".concat(index_js_1.apiUrl, "/AccountingContact"), {
                            method: "POST",
                            headers: {
                                Authorization: this.apiKey,
     ...
     * @returns
     */
    AccountingContact.prototype.findAccountingContactByID = function (accountingContactId) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, (0, node_fetch_1.default)("".concat(index_js_1.apiUrl, "/AccountingContact/").concat(accountingContactId), {
                            method: "GET",
                            headers: {
                                Authorization: this.apiKey,
                            },
     ...
     */
    AccountingContact.prototype.updateAnExistingAccountingContact = function (accountingContactId, body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.text()];
                    case 3:
                        responseObj = (_a.response = (_b.body = _c.sent(),
                            _b.bodyUsed = response.bodyUsed,
                            _b.data = data ? data : null,
                            _b.headers = response.headers,
                            _b.ok = response.ok,
    ...
    AccountingContact.prototype.deletesAnAccountingContact = function (accountingContactId) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            var _a, _b;
            return __generator(this, function (_c) {
